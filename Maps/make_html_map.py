...
tooltip_reform = folium.features.GeoJsonTooltip(['Empty'], aliases=['Reform map'])
...
folium.features.GeoJson(df_enacted, name='Enacted map', style_function=style_function, show=False, tooltip=tooltip('Enacted map')).add_to(m)
