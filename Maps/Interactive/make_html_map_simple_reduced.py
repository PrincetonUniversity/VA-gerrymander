...
note_box = '''
     <div style="position: fixed; top: 12px; right: 150px; border: 0px; z-index: 9999; font-size: 13px; border-radius: 5px; background-color: #fff; padding: 8px; box-shadow: 0px 2px 4px #888; opacity: 1; width: 160px; max-width: 45em; overflow: auto; white-space: nowrap">
     <b style="font-size: 12px">Note: Due to Leaflet.js,<br>after selecting an<br>overlay map (checkbox)<br>basemaps (radio button)<br>must be reselected to be<br>displayed on top
      </div>
    '''
