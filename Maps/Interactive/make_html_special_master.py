...
path = '/Users/hwheelen/Documents/GitHub/VA-gerrymander/Maps/'

maps = {'reform': {'name': 'PGP Reform map',
                   'path': 'Reform map/Districts map bethune-hill final.shp',
                   'district_colname': 'DISTRICT',
                   'show': True},
        'enacted': {'name': 'Enacted map',
                    'path': 'Enacted map/enacted.shp',
                    'district_colname': 'ID',
                    'show': False},
        'SM_Richmond_1A':    {'name': 'Special Master Richmond 1A',
                    'path': 'Special Master Map/Richmond_1A/Richmond_1A.shp',
                    'district_colname': 'District_N',
                    'show': False},
        'SM_Richmond_1B':    {'name': 'Special Master Richmond 1B',
                    'path': 'Special Master Map/Richmond_1B/Richmond_1B.shp',
                    'district_colname': 'District_N',
                    'show': False},
        'SM_Petersburg_1A':    {'name': 'Special Master Petersburg 1A',
                    'path': 'Special Master Map/Petersburg_1A/Petersburg_1A.shp',
                    'district_colname': 'District_N',
                    'show': False},
        'SM_Petersburg_1B':    {'name': 'Special Master Petersburg 1B',
                    'path': 'Special Master Map/Petersburg_1B/Petersburg_1B.shp',
                    'district_colname': 'District_N',
                    'show': False},
        'SM_Petersburg_2':    {'name': 'Special Master Petersburg 2',
                    'path': 'Special Master Map/Petersburg_2/Petersburg_2.shp',
                    'district_colname': 'District_N',
                    'show': False},
        'SM_Peninsula_1':    {'name': 'Special Master Peninsula 1',
                    'path': 'Special Master Map/Peninsula_1/Peninsula_1.shp',
                    'district_colname': 'District_N',
                    'show': False},
        'SM_Peninsula_2':    {'name': 'Special Master Peninsula 2',
                    'path': 'Special Master Map/Peninsula_2/Peninsula_2.shp',
                    'district_colname': 'District_N',
                    'show': False},
        'SM_Norfolk_1A':    {'name': 'Special Master Norfolk 1A',
                    'path': 'Special Master Map/Norfolk_1A/Norfolk_1A.shp',
                    'district_colname': 'District_N',
                    'show': False},
        'SM_Norfolk_1B':    {'name': 'Special Master Norfolk 1B',
                    'path': 'Special Master Map/Norfolk_1B/Norfolk_1B.shp',
                    'district_colname': 'District_N',
                    'show': False},
        'SM_Norfolk_1C':    {'name': 'Special Master Norfolk 1C',
                    'path': 'Special Master Map/Norfolk_1C/Norfolk_1C.shp',
                    'district_colname': 'District_N',
                    'show': False}
        }
maps = {'SM_Richmond_1A':    {'name': 'Special Master Richmond 1A',
                    'path': '/Users/hwheelen/Documents/GitHub/VA-gerrymander/Maps/Special Master Map/Richmond_1A/Richmond_1A.shp',
                    'district_colname': 'District_N',
                    'show': False}
        }

common_colname = 'district_n'

# Iterate through every option on the interactive map
for mapname in maps:
    # load in dataframe
    df = gpd.read_file(path + maps[mapname]['path'])
...
filename = "/Users/hwheelen/Documents/GitHub/VA-gerrymander/Maps/Interactive/map_comparison_SM.html"
m.save(filename)
